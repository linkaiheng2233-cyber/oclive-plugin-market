...
export const mumu = {
  ...
  homeTitle: '嗨，欢迎进来逛逛～',
  homeLead:
    '这里是大家分享角色包、插件和小模块的地方。随便翻翻，有好东西也可以挂上来，让路过的人都能摸到。',
  homeWelcomeNoAnn:
    '今天还没有新公告，不急，先去「浏览资源」里转转，说不定能挖到宝～',
  annLoading: '等我一下……公告马上来',
  annLabel: '最新公告',

  hubBrowse: { title: '浏览资源', desc: '看看大家挂了啥：角色包、插件、模块、分支都有～' },
  hubSubmit: { title: '发布资源', desc: '登录之后就能贴下载链接和说明啦，第一个投稿也超欢迎！' },
  hubAnnouncements: { title: '公告栏', desc: '维护通知、社区碎碎念，都会贴在这边。' },
  hubVersions: { title: '版本与下载', desc: '启动器、主程序、编写器去哪儿下？点这里。' },
  ...
  browseTitle: '逛逛都有啥',
  browseSub: '下面都是已发布的投稿；可以搜关键字、按类型筛、排个序～',
  ...
  dlHint: '下载链接是作者自己填的，点之前多留个心眼哦；出问题沐沐这边可背不了锅～',
  ...
  submitErrorUrl: '除了公告以外，下载链接也要填的～',
